###########################################################################
## Makefile generated for component 'PD_feed_forward'. 
## 
## Makefile     : PD_feed_forward.mk
## Generated on : Thu Mar 16 12:13:10 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\PD_feed_forward.rt-win64
...
PRODUCT_NAME              = PD_feed_forward
MAKEFILE                  = PD_feed_forward.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\STUDEN~1\DOCUME~1\MATLAB\ORTONG~1\135C57~1\slow
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = PD_feed_forward_comp.rsp
CMD_FILE                  = PD_feed_forward.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\PD_feed_forward.rt-win64
...
DEFINES_STANDARD = -DMODEL=PD_feed_forward -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\PD_feed_forward_quarc_win64\PD_feed_forward.c $(START_DIR)\PD_feed_forward_quarc_win64\PD_feed_forward_data.c $(START_DIR)\PD_feed_forward_quarc_win64\PD_feed_forward_main.c $(START_DIR)\PD_feed_forward_quarc_win64\rtGetInf.c $(START_DIR)\PD_feed_forward_quarc_win64\rtGetNaN.c $(START_DIR)\PD_feed_forward_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = PD_feed_forward.obj PD_feed_forward_data.obj PD_feed_forward_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\PD_feed_forward_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\PD_feed_forward_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
PD_feed_forward.obj : $(START_DIR)\PD_feed_forward_quarc_win64\PD_feed_forward.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_feed_forward_quarc_win64\PD_feed_forward.c


PD_feed_forward_data.obj : $(START_DIR)\PD_feed_forward_quarc_win64\PD_feed_forward_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_feed_forward_quarc_win64\PD_feed_forward_data.c


PD_feed_forward_main.obj : $(START_DIR)\PD_feed_forward_quarc_win64\PD_feed_forward_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_feed_forward_quarc_win64\PD_feed_forward_main.c


rtGetInf.obj : $(START_DIR)\PD_feed_forward_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_feed_forward_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\PD_feed_forward_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_feed_forward_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\PD_feed_forward_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_feed_forward_quarc_win64\rt_nonfinite.c
