...
void PD_feed_forward_output0(void)     /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (H12 < 1.0) {
    ...
    /* '<S6>:1:13' */
    theta_idx_1 = 6.2831853071795862 * PD_feed_forward_P.Speed_Value * (H12 -
      1.25);
    PD_feed_forward_B.x[0] = cos(theta_idx_1) * 0.075 + 0.125;
...
RT_MODEL_PD_feed_forward_T *PD_feed_forward(void)
{
  ...
  /* External mode info */
  PD_feed_forward_M->Sizes.checksums[0] = (3821763740U);
  PD_feed_forward_M->Sizes.checksums[1] = (2958345714U);
  PD_feed_forward_M->Sizes.checksums[2] = (4043224146U);
  PD_feed_forward_M->Sizes.checksums[3] = (3020424500U);
  ...
  PD_feed_forward_M->Sizes.numBlocks = (42);/* Number of blocks */
  PD_feed_forward_M->Sizes.numBlockIO = (11);/* Number of block outputs */
