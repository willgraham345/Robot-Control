 ...
 * C source code generated on : Thu Mar 16 12:12:00 2023
 *
...
#ifndef RTW_HEADER_PD_feed_forward_h_
#define RTW_HEADER_PD_feed_forward_h_
#include <math.h>
#include <string.h>
#ifndef PD_feed_forward_COMMON_INCLUDES_
#define PD_feed_forward_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* PD_feed_forward_COMMON_INCLUDES_ */

#include "PD_feed_forward_types.h"
...
#define PD_feed_forward_rtModel        RT_MODEL_PD_feed_forward_T

/* Block signals (default storage) */
typedef struct {
  real_T EncoderGain[2];               /* '<S4>/Encoder Gain' */
  ...
  real_T uAmpGain[2];                  /* '<S4>/1//AmpGain' */
  real_T CurrentSenseBiasTuneforeachampc[2];
            /* '<S4>/Current Sense Bias Tune for each amp//channel if needed' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } MotorCurrentCommands_PWORK;        /* '<S4>/Motor Current Commands' */

  void *HILReadAnalog_PWORK;           /* '<S4>/HIL Read Analog' */
  struct {
    void *LoggedData;
  } ActualMotorCurrents_PWORK;         /* '<S4>/Actual Motor Currents' */
...
typedef struct {
  real_T Filter_CSTATE[2];             /* '<S34>/Filter' */
} XDot_PD_feed_forward_T;

/* State disabled  */
typedef struct {
  boolean_T Filter_CSTATE[2];          /* '<S34>/Filter' */
} XDis_PD_feed_forward_T;
...
#define rtB                            PD_feed_forward_B
#define BlockIO                        B_PD_feed_forward_T
#define rtX                            PD_feed_forward_X
#define ContinuousStates               X_PD_feed_forward_T
#define rtXdot                         PD_feed_forward_XDot
#define StateDerivatives               XDot_PD_feed_forward_T
#define tXdis                          PD_feed_forward_XDis
#define StateDisabled                  XDis_PD_feed_forward_T
#define rtP                            PD_feed_forward_P
#define Parameters                     P_PD_feed_forward_T
#define rtDWork                        PD_feed_forward_DW
#define D_Work                         DW_PD_feed_forward_T

/* Parameters (default storage) */
struct P_PD_feed_forward_T_ {
  real_T PDController_D;               /* Mask Parameter: PDController_D
  ...
  real_T PDController_N;               /* Mask Parameter: PDController_N
                                        ...
                                        */
  real_T PDController_P;               /* Mask Parameter: PDController_P
...
struct tag_RTM_PD_feed_forward_T {
  const char_T *path;
...
extern P_PD_feed_forward_T PD_feed_forward_P;

/* Block signals (default storage) */
extern B_PD_feed_forward_T PD_feed_forward_B;

/* Continuous states (default storage) */
extern X_PD_feed_forward_T PD_feed_forward_X;

/* Block states (default storage) */
extern DW_PD_feed_forward_T PD_feed_forward_DW;
...
extern void PD_feed_forward_initialize(void);
extern void PD_feed_forward_output0(void);
extern void PD_feed_forward_update0(void);
extern void PD_feed_forward_output2(void);
extern void PD_feed_forward_update2(void);
extern void PD_feed_forward_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern PD_feed_forward_rtModel *PD_feed_forward(void);
...
extern RT_MODEL_PD_feed_forward_T *const PD_feed_forward_M;
 ...
 *
 * '<Root>' : 'PD_feed_forward'
 * '<S1>'   : 'PD_feed_forward/Forward Kinematics'
 * '<S2>'   : 'PD_feed_forward/Inverse Kinematics'
 * '<S3>'   : 'PD_feed_forward/PD Controller'
 * '<S4>'   : 'PD_feed_forward/Robot Subsystem'
 * '<S5>'   : 'PD_feed_forward/Torque Feedforward'
 * '<S6>'   : 'PD_feed_forward/Trajectory  Generator'
 * '<S7>'   : 'PD_feed_forward/XY Plotter'
 * '<S8>'   : 'PD_feed_forward/PD Controller/Anti-windup'
 * '<S9>'   : 'PD_feed_forward/PD Controller/D Gain'
 * '<S10>'  : 'PD_feed_forward/PD Controller/Filter'
 * '<S11>'  : 'PD_feed_forward/PD Controller/Filter ICs'
 * '<S12>'  : 'PD_feed_forward/PD Controller/I Gain'
 * '<S13>'  : 'PD_feed_forward/PD Controller/Ideal P Gain'
 * '<S14>'  : 'PD_feed_forward/PD Controller/Ideal P Gain Fdbk'
 * '<S15>'  : 'PD_feed_forward/PD Controller/Integrator'
 * '<S16>'  : 'PD_feed_forward/PD Controller/Integrator ICs'
 * '<S17>'  : 'PD_feed_forward/PD Controller/N Copy'
 * '<S18>'  : 'PD_feed_forward/PD Controller/N Gain'
 * '<S19>'  : 'PD_feed_forward/PD Controller/P Copy'
 * '<S20>'  : 'PD_feed_forward/PD Controller/Parallel P Gain'
 * '<S21>'  : 'PD_feed_forward/PD Controller/Reset Signal'
 * '<S22>'  : 'PD_feed_forward/PD Controller/Saturation'
 * '<S23>'  : 'PD_feed_forward/PD Controller/Saturation Fdbk'
 * '<S24>'  : 'PD_feed_forward/PD Controller/Sum'
 * '<S25>'  : 'PD_feed_forward/PD Controller/Sum Fdbk'
 * '<S26>'  : 'PD_feed_forward/PD Controller/Tracking Mode'
 * '<S27>'  : 'PD_feed_forward/PD Controller/Tracking Mode Sum'
 * '<S28>'  : 'PD_feed_forward/PD Controller/Tsamp - Integral'
 * '<S29>'  : 'PD_feed_forward/PD Controller/Tsamp - Ngain'
 * '<S30>'  : 'PD_feed_forward/PD Controller/postSat Signal'
 * '<S31>'  : 'PD_feed_forward/PD Controller/preSat Signal'
 * '<S32>'  : 'PD_feed_forward/PD Controller/Anti-windup/Disabled'
 * '<S33>'  : 'PD_feed_forward/PD Controller/D Gain/Internal Parameters'
 * '<S34>'  : 'PD_feed_forward/PD Controller/Filter/Cont. Filter'
 * '<S35>'  : 'PD_feed_forward/PD Controller/Filter ICs/Internal IC - Filter'
 * '<S36>'  : 'PD_feed_forward/PD Controller/I Gain/Disabled'
 * '<S37>'  : 'PD_feed_forward/PD Controller/Ideal P Gain/Passthrough'
 * '<S38>'  : 'PD_feed_forward/PD Controller/Ideal P Gain Fdbk/Disabled'
 * '<S39>'  : 'PD_feed_forward/PD Controller/Integrator/Disabled'
 * '<S40>'  : 'PD_feed_forward/PD Controller/Integrator ICs/Disabled'
 * '<S41>'  : 'PD_feed_forward/PD Controller/N Copy/Disabled'
 * '<S42>'  : 'PD_feed_forward/PD Controller/N Gain/Internal Parameters'
 * '<S43>'  : 'PD_feed_forward/PD Controller/P Copy/Disabled'
 * '<S44>'  : 'PD_feed_forward/PD Controller/Parallel P Gain/Internal Parameters'
 * '<S45>'  : 'PD_feed_forward/PD Controller/Reset Signal/Disabled'
 * '<S46>'  : 'PD_feed_forward/PD Controller/Saturation/Passthrough'
 * '<S47>'  : 'PD_feed_forward/PD Controller/Saturation Fdbk/Disabled'
 * '<S48>'  : 'PD_feed_forward/PD Controller/Sum/Sum_PD'
 * '<S49>'  : 'PD_feed_forward/PD Controller/Sum Fdbk/Disabled'
 * '<S50>'  : 'PD_feed_forward/PD Controller/Tracking Mode/Disabled'
 * '<S51>'  : 'PD_feed_forward/PD Controller/Tracking Mode Sum/Passthrough'
 * '<S52>'  : 'PD_feed_forward/PD Controller/Tsamp - Integral/Disabled wSignal Specification'
 * '<S53>'  : 'PD_feed_forward/PD Controller/Tsamp - Ngain/Passthrough'
 * '<S54>'  : 'PD_feed_forward/PD Controller/postSat Signal/Forward_Path'
 * '<S55>'  : 'PD_feed_forward/PD Controller/preSat Signal/Forward_Path'
 */
#endif                                 /* RTW_HEADER_PD_feed_forward_h_ */
