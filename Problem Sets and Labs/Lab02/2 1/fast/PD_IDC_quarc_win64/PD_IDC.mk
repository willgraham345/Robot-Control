###########################################################################
## Makefile generated for component 'PD_IDC'. 
## 
## Makefile     : PD_IDC.mk
## Generated on : Thu Mar 16 12:20:50 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\PD_IDC.rt-win64
...
START_DIR                 = C:\Users\STUDEN~1\DOCUME~1\MATLAB\ORTONG~1\218D6B~1\fast
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = PD_IDC_comp.rsp
CMD_FILE                  = PD_IDC.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\PD_IDC.rt-win64
...
DEFINES_STANDARD = -DMODEL=PD_IDC -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\PD_IDC_quarc_win64\PD_IDC.c $(START_DIR)\PD_IDC_quarc_win64\PD_IDC_data.c $(START_DIR)\PD_IDC_quarc_win64\PD_IDC_main.c $(START_DIR)\PD_IDC_quarc_win64\rtGetInf.c $(START_DIR)\PD_IDC_quarc_win64\rtGetNaN.c $(START_DIR)\PD_IDC_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = PD_IDC.obj PD_IDC_data.obj PD_IDC_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\PD_IDC_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\PD_IDC_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
PD_IDC.obj : $(START_DIR)\PD_IDC_quarc_win64\PD_IDC.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_IDC_quarc_win64\PD_IDC.c


PD_IDC_data.obj : $(START_DIR)\PD_IDC_quarc_win64\PD_IDC_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_IDC_quarc_win64\PD_IDC_data.c


PD_IDC_main.obj : $(START_DIR)\PD_IDC_quarc_win64\PD_IDC_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_IDC_quarc_win64\PD_IDC_main.c


rtGetInf.obj : $(START_DIR)\PD_IDC_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_IDC_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\PD_IDC_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_IDC_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\PD_IDC_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PD_IDC_quarc_win64\rt_nonfinite.c
