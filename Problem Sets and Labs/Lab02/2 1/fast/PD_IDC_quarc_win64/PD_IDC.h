 ...
 * C source code generated on : Thu Mar 16 12:20:46 2023
 *
...
#ifndef RTW_HEADER_PD_IDC_h_
#define RTW_HEADER_PD_IDC_h_
#include <math.h>
#include <string.h>
#ifndef PD_IDC_COMMON_INCLUDES_
#define PD_IDC_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* PD_IDC_COMMON_INCLUDES_ */

#include "PD_IDC_types.h"
...
#define PD_IDC_rtModel                 RT_MODEL_PD_IDC_T
...
#define rtB                            PD_IDC_B
#define BlockIO                        B_PD_IDC_T
#define rtX                            PD_IDC_X
#define ContinuousStates               X_PD_IDC_T
#define rtXdot                         PD_IDC_XDot
#define StateDerivatives               XDot_PD_IDC_T
#define tXdis                          PD_IDC_XDis
#define StateDisabled                  XDis_PD_IDC_T
#define rtP                            PD_IDC_P
#define Parameters                     P_PD_IDC_T
#define rtDWork                        PD_IDC_DW
#define D_Work                         DW_PD_IDC_T
...
extern P_PD_IDC_T PD_IDC_P;

/* Block signals (default storage) */
extern B_PD_IDC_T PD_IDC_B;

/* Continuous states (default storage) */
extern X_PD_IDC_T PD_IDC_X;

/* Block states (default storage) */
extern DW_PD_IDC_T PD_IDC_DW;
...
extern void PD_IDC_initialize(void);
extern void PD_IDC_output0(void);
extern void PD_IDC_update0(void);
extern void PD_IDC_output2(void);
extern void PD_IDC_update2(void);
extern void PD_IDC_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern PD_IDC_rtModel *PD_IDC(void);
...
extern RT_MODEL_PD_IDC_T *const PD_IDC_M;
 ...
 *
 * '<Root>' : 'PD_IDC'
 * '<S1>'   : 'PD_IDC/Feedback Comp'
 * '<S2>'   : 'PD_IDC/Forward Kinematics'
 * '<S3>'   : 'PD_IDC/Inertia Matrix'
 * '<S4>'   : 'PD_IDC/Inverse Kinematics'
 * '<S5>'   : 'PD_IDC/PID Controller'
 * '<S6>'   : 'PD_IDC/Robot Subsystem'
 * '<S7>'   : 'PD_IDC/Trajectory  Generator'
 * '<S8>'   : 'PD_IDC/XY Plotter'
 * '<S9>'   : 'PD_IDC/PID Controller/Anti-windup'
 * '<S10>'  : 'PD_IDC/PID Controller/D Gain'
 * '<S11>'  : 'PD_IDC/PID Controller/Filter'
 * '<S12>'  : 'PD_IDC/PID Controller/Filter ICs'
 * '<S13>'  : 'PD_IDC/PID Controller/I Gain'
 * '<S14>'  : 'PD_IDC/PID Controller/Ideal P Gain'
 * '<S15>'  : 'PD_IDC/PID Controller/Ideal P Gain Fdbk'
 * '<S16>'  : 'PD_IDC/PID Controller/Integrator'
 * '<S17>'  : 'PD_IDC/PID Controller/Integrator ICs'
 * '<S18>'  : 'PD_IDC/PID Controller/N Copy'
 * '<S19>'  : 'PD_IDC/PID Controller/N Gain'
 * '<S20>'  : 'PD_IDC/PID Controller/P Copy'
 * '<S21>'  : 'PD_IDC/PID Controller/Parallel P Gain'
 * '<S22>'  : 'PD_IDC/PID Controller/Reset Signal'
 * '<S23>'  : 'PD_IDC/PID Controller/Saturation'
 * '<S24>'  : 'PD_IDC/PID Controller/Saturation Fdbk'
 * '<S25>'  : 'PD_IDC/PID Controller/Sum'
 * '<S26>'  : 'PD_IDC/PID Controller/Sum Fdbk'
 * '<S27>'  : 'PD_IDC/PID Controller/Tracking Mode'
 * '<S28>'  : 'PD_IDC/PID Controller/Tracking Mode Sum'
 * '<S29>'  : 'PD_IDC/PID Controller/Tsamp - Integral'
 * '<S30>'  : 'PD_IDC/PID Controller/Tsamp - Ngain'
 * '<S31>'  : 'PD_IDC/PID Controller/postSat Signal'
 * '<S32>'  : 'PD_IDC/PID Controller/preSat Signal'
 * '<S33>'  : 'PD_IDC/PID Controller/Anti-windup/Disabled'
 * '<S34>'  : 'PD_IDC/PID Controller/D Gain/Internal Parameters'
 * '<S35>'  : 'PD_IDC/PID Controller/Filter/Cont. Filter'
 * '<S36>'  : 'PD_IDC/PID Controller/Filter ICs/Internal IC - Filter'
 * '<S37>'  : 'PD_IDC/PID Controller/I Gain/Disabled'
 * '<S38>'  : 'PD_IDC/PID Controller/Ideal P Gain/Passthrough'
 * '<S39>'  : 'PD_IDC/PID Controller/Ideal P Gain Fdbk/Disabled'
 * '<S40>'  : 'PD_IDC/PID Controller/Integrator/Disabled'
 * '<S41>'  : 'PD_IDC/PID Controller/Integrator ICs/Disabled'
 * '<S42>'  : 'PD_IDC/PID Controller/N Copy/Disabled'
 * '<S43>'  : 'PD_IDC/PID Controller/N Gain/Internal Parameters'
 * '<S44>'  : 'PD_IDC/PID Controller/P Copy/Disabled'
 * '<S45>'  : 'PD_IDC/PID Controller/Parallel P Gain/Internal Parameters'
 * '<S46>'  : 'PD_IDC/PID Controller/Reset Signal/Disabled'
 * '<S47>'  : 'PD_IDC/PID Controller/Saturation/Passthrough'
 * '<S48>'  : 'PD_IDC/PID Controller/Saturation Fdbk/Disabled'
 * '<S49>'  : 'PD_IDC/PID Controller/Sum/Sum_PD'
 * '<S50>'  : 'PD_IDC/PID Controller/Sum Fdbk/Disabled'
 * '<S51>'  : 'PD_IDC/PID Controller/Tracking Mode/Disabled'
 * '<S52>'  : 'PD_IDC/PID Controller/Tracking Mode Sum/Passthrough'
 * '<S53>'  : 'PD_IDC/PID Controller/Tsamp - Integral/Disabled wSignal Specification'
 * '<S54>'  : 'PD_IDC/PID Controller/Tsamp - Ngain/Passthrough'
 * '<S55>'  : 'PD_IDC/PID Controller/postSat Signal/Forward_Path'
 * '<S56>'  : 'PD_IDC/PID Controller/preSat Signal/Forward_Path'
 */
#endif                                 /* RTW_HEADER_PD_IDC_h_ */
