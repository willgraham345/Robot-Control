...
void PD_gfc_comp_output0(void)         /* Sample time: [0.0s, 0.0s] */
{
   ...
   *  Sum: '<S34>/SumD'
   */
  PD_gfc_comp_B.FilterCoefficient[0] = (PD_gfc_comp_P.PDController_D[0] *
   ...
   *  Sum: '<S34>/SumD'
   */
  PD_gfc_comp_B.FilterCoefficient[1] = (PD_gfc_comp_P.PDController_D[1] *
  ...
  PD_gfc_comp_B.Current[1] = (((h * rtb_Derivative_idx_0_0 + 0.0 *
    ...
    PD_gfc_comp_P.uMotorGain_Gain + (PD_gfc_comp_P.PDController_P[1] *
    PD_gfc_comp_B.Sum[1] + PD_gfc_comp_B.FilterCoefficient[1]);

  /* Gain: '<Root>/1//AmpGain (V//A)' incorporates:
   *  Sum: '<Root>/Sum1'
   */
  PD_gfc_comp_B.uAmpGainVA[1] = PD_gfc_comp_P.uAmpGainVA_Gain *
    PD_gfc_comp_B.Current[1];

  /* Gain: '<S5>/1//AmpGain' incorporates:
   *  Bias: '<S5>/Amp Bias Tune for each  amp//channel if needed'
   *  Gain: '<Root>/1//AmpGain (V//A)'
   */
  PD_gfc_comp_B.uAmpGain[1] = (PD_gfc_comp_B.uAmpGainVA[1] +
...
RT_MODEL_PD_gfc_comp_T *PD_gfc_comp(void)
{
  ...
  /* External mode info */
  PD_gfc_comp_M->Sizes.checksums[0] = (3558415681U);
  PD_gfc_comp_M->Sizes.checksums[1] = (1507591713U);
  PD_gfc_comp_M->Sizes.checksums[2] = (1950005553U);
  PD_gfc_comp_M->Sizes.checksums[3] = (3153022592U);
...

  {
    ...
    PD_gfc_comp_B.uAmpGainVA[0] = 0.0;
    PD_gfc_comp_B.uAmpGainVA[1] = 0.0;
  ...
  PD_gfc_comp_M->Sizes.numBlocks = (41);/* Number of blocks */
  PD_gfc_comp_M->Sizes.numBlockIO = (10);/* Number of block outputs */
  PD_gfc_comp_M->Sizes.numBlockPrms = (129);/* Sum of parameter "widths" */
