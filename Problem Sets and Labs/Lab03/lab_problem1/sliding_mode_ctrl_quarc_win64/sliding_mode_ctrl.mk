###########################################################################
## Makefile generated for component 'sliding_mode_ctrl'. 
## 
## Makefile     : sliding_mode_ctrl.mk
## Generated on : Thu Mar 23 11:15:02 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\sliding_mode_ctrl.rt-win64
...
PRODUCT_NAME              = sliding_mode_ctrl
MAKEFILE                  = sliding_mode_ctrl.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\STUDEN~1\DOCUME~1\ORTONG~1\problem1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = sliding_mode_ctrl_comp.rsp
CMD_FILE                  = sliding_mode_ctrl.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\sliding_mode_ctrl.rt-win64
...
DEFINES_STANDARD = -DMODEL=sliding_mode_ctrl -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\sliding_mode_ctrl_quarc_win64\rtGetInf.c $(START_DIR)\sliding_mode_ctrl_quarc_win64\rtGetNaN.c $(START_DIR)\sliding_mode_ctrl_quarc_win64\rt_nonfinite.c $(START_DIR)\sliding_mode_ctrl_quarc_win64\sliding_mode_ctrl.c $(START_DIR)\sliding_mode_ctrl_quarc_win64\sliding_mode_ctrl_data.c $(START_DIR)\sliding_mode_ctrl_quarc_win64\sliding_mode_ctrl_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj sliding_mode_ctrl.obj sliding_mode_ctrl_data.obj sliding_mode_ctrl_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\sliding_mode_ctrl_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\sliding_mode_ctrl_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : $(START_DIR)\sliding_mode_ctrl_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sliding_mode_ctrl_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\sliding_mode_ctrl_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sliding_mode_ctrl_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\sliding_mode_ctrl_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sliding_mode_ctrl_quarc_win64\rt_nonfinite.c


sliding_mode_ctrl.obj : $(START_DIR)\sliding_mode_ctrl_quarc_win64\sliding_mode_ctrl.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sliding_mode_ctrl_quarc_win64\sliding_mode_ctrl.c


sliding_mode_ctrl_data.obj : $(START_DIR)\sliding_mode_ctrl_quarc_win64\sliding_mode_ctrl_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sliding_mode_ctrl_quarc_win64\sliding_mode_ctrl_data.c


sliding_mode_ctrl_main.obj : $(START_DIR)\sliding_mode_ctrl_quarc_win64\sliding_mode_ctrl_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\sliding_mode_ctrl_quarc_win64\sliding_mode_ctrl_main.c
