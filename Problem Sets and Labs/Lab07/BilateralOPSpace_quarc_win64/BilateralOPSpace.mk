###########################################################################
## Makefile generated for component 'BilateralOPSpace'. 
## 
## Makefile     : BilateralOPSpace.mk
## Generated on : Tue Apr 25 11:07:02 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\BilateralOPSpace.rt-win64
...
COMPILER_COMMAND_FILE     = BilateralOPSpace_comp.rsp
CMD_FILE                  = BilateralOPSpace.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\BilateralOPSpace.rt-win64
...
DEFINES_STANDARD = -DMODEL=BilateralOPSpace -DNUMST=3 -DNCSTATES=8 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\BilateralOPSpace_quarc_win64\BilateralOPSpace.c $(START_DIR)\BilateralOPSpace_quarc_win64\BilateralOPSpace_data.c $(START_DIR)\BilateralOPSpace_quarc_win64\BilateralOPSpace_main.c $(START_DIR)\BilateralOPSpace_quarc_win64\rtGetInf.c $(START_DIR)\BilateralOPSpace_quarc_win64\rtGetNaN.c $(START_DIR)\BilateralOPSpace_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = BilateralOPSpace.obj BilateralOPSpace_data.obj BilateralOPSpace_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\BilateralOPSpace_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BilateralOPSpace_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
BilateralOPSpace.obj : $(START_DIR)\BilateralOPSpace_quarc_win64\BilateralOPSpace.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\BilateralOPSpace_quarc_win64\BilateralOPSpace.c


BilateralOPSpace_data.obj : $(START_DIR)\BilateralOPSpace_quarc_win64\BilateralOPSpace_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\BilateralOPSpace_quarc_win64\BilateralOPSpace_data.c


BilateralOPSpace_main.obj : $(START_DIR)\BilateralOPSpace_quarc_win64\BilateralOPSpace_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\BilateralOPSpace_quarc_win64\BilateralOPSpace_main.c


rtGetInf.obj : $(START_DIR)\BilateralOPSpace_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\BilateralOPSpace_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\BilateralOPSpace_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\BilateralOPSpace_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\BilateralOPSpace_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\BilateralOPSpace_quarc_win64\rt_nonfinite.c
