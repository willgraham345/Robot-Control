###########################################################################
## Makefile generated for component 'p3'. 
## 
## Makefile     : p3.mk
## Generated on : Tue Apr 25 10:58:35 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\p3.rt-win64
...
COMPILER_COMMAND_FILE     = p3_comp.rsp
CMD_FILE                  = p3.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\p3.rt-win64
...
DEFINES_STANDARD = -DMODEL=p3 -DNUMST=3 -DNCSTATES=8 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\p3_quarc_win64\p3.c $(START_DIR)\p3_quarc_win64\p3_data.c $(START_DIR)\p3_quarc_win64\p3_main.c $(START_DIR)\p3_quarc_win64\rtGetInf.c $(START_DIR)\p3_quarc_win64\rtGetNaN.c $(START_DIR)\p3_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = p3.obj p3_data.obj p3_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\p3_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\p3_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
p3.obj : $(START_DIR)\p3_quarc_win64\p3.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p3_quarc_win64\p3.c


p3_data.obj : $(START_DIR)\p3_quarc_win64\p3_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p3_quarc_win64\p3_data.c


p3_main.obj : $(START_DIR)\p3_quarc_win64\p3_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p3_quarc_win64\p3_main.c


rtGetInf.obj : $(START_DIR)\p3_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p3_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\p3_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p3_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\p3_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p3_quarc_win64\rt_nonfinite.c
