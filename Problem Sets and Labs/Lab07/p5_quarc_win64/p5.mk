###########################################################################
## Makefile generated for component 'p5'. 
## 
## Makefile     : p5.mk
## Generated on : Tue Apr 25 11:08:05 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\p5.rt-win64
...
COMPILER_COMMAND_FILE     = p5_comp.rsp
CMD_FILE                  = p5.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\p5.rt-win64
...
DEFINES_STANDARD = -DMODEL=p5 -DNUMST=3 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\p5_quarc_win64\p5.c $(START_DIR)\p5_quarc_win64\p5_data.c $(START_DIR)\p5_quarc_win64\p5_main.c $(START_DIR)\p5_quarc_win64\rtGetInf.c $(START_DIR)\p5_quarc_win64\rtGetNaN.c $(START_DIR)\p5_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = p5.obj p5_data.obj p5_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\p5_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\p5_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
p5.obj : $(START_DIR)\p5_quarc_win64\p5.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p5_quarc_win64\p5.c


p5_data.obj : $(START_DIR)\p5_quarc_win64\p5_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p5_quarc_win64\p5_data.c


p5_main.obj : $(START_DIR)\p5_quarc_win64\p5_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p5_quarc_win64\p5_main.c


rtGetInf.obj : $(START_DIR)\p5_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p5_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\p5_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p5_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\p5_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p5_quarc_win64\rt_nonfinite.c
