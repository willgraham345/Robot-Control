    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% p5_P.PIDController_I
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% p5_P.PIDController_InitialConditionF
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 2;

                    ;% p5_P.PIDController_P
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% p5_P.HILReadEncoder_channels
                    section.data(1).logicalSrcIdx = 3;
                    section.data(1).dtTransOffset = 0;

                    ;% p5_P.HILWriteAnalog_channels
                    section.data(2).logicalSrcIdx = 4;
                    section.data(2).dtTransOffset = 2;

                    ;% p5_P.HILReadAnalog_channels
            ...
            section.data(34)  = dumData; %prealloc
                    ...
                    ;% p5_P.HILInitialize_OOTerminate
                    section.data(1).logicalSrcIdx = 6;
                    section.data(1).dtTransOffset = 0;

                    ;% p5_P.HILInitialize_OOExit
                    section.data(2).logicalSrcIdx = 7;
                    section.data(2).dtTransOffset = 1;

                    ;% p5_P.HILInitialize_OOStart
                    section.data(3).logicalSrcIdx = 8;
                    section.data(3).dtTransOffset = 2;

                    ;% p5_P.HILInitialize_OOEnter
                    section.data(4).logicalSrcIdx = 9;
                    section.data(4).dtTransOffset = 3;

                    ;% p5_P.HILInitialize_AOFinal
                    section.data(5).logicalSrcIdx = 10;
                    section.data(5).dtTransOffset = 4;

                    ;% p5_P.HILInitialize_POFinal
                    section.data(6).logicalSrcIdx = 11;
                    section.data(6).dtTransOffset = 8;

                    ;% p5_P.HILInitialize_AIHigh
                    section.data(7).logicalSrcIdx = 12;
                    section.data(7).dtTransOffset = 9;

                    ;% p5_P.HILInitialize_AILow
                    section.data(8).logicalSrcIdx = 13;
                    section.data(8).dtTransOffset = 10;

                    ;% p5_P.HILInitialize_AOHigh
                    section.data(9).logicalSrcIdx = 14;
                    section.data(9).dtTransOffset = 11;

                    ;% p5_P.HILInitialize_AOLow
                    section.data(10).logicalSrcIdx = 15;
                    section.data(10).dtTransOffset = 12;

                    ;% p5_P.HILInitialize_AOInitial
                    section.data(11).logicalSrcIdx = 16;
                    section.data(11).dtTransOffset = 13;

                    ;% p5_P.HILInitialize_AOWatchdog
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% p5_P.HILInitialize_CKChannels
                    section.data(1).logicalSrcIdx = 40;
                    section.data(1).dtTransOffset = 0;

                    ;% p5_P.HILInitialize_DOWatchdog
                    section.data(2).logicalSrcIdx = 41;
                    section.data(2).dtTransOffset = 3;

                    ;% p5_P.HILInitialize_EIInitial
                    section.data(3).logicalSrcIdx = 42;
                    section.data(3).dtTransOffset = 4;

                    ;% p5_P.HILInitialize_POModes
                    section.data(4).logicalSrcIdx = 43;
                    section.data(4).dtTransOffset = 5;

                    ;% p5_P.HILInitialize_POConfiguration
                    section.data(5).logicalSrcIdx = 44;
                    section.data(5).dtTransOffset = 6;

                    ;% p5_P.HILInitialize_POAlignment
                    section.data(6).logicalSrcIdx = 45;
                    section.data(6).dtTransOffset = 7;

                    ;% p5_P.HILInitialize_POPolarity
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% p5_P.HILInitialize_EIChannels
                    section.data(3).logicalSrcIdx = 49;
                    section.data(3).dtTransOffset = 16;

                    ;% p5_P.HILInitialize_EIQuadrature
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% p5_B.sf_JacobianTranspose2.tau
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% p5_B.sf_JacobianTranspose1.tau
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(17)  = dumData; %prealloc
                    ...
                    ;% p5_DW.HILInitialize_AIMinimums
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% p5_DW.HILInitialize_AIMaximums
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 8;

                    ;% p5_DW.HILInitialize_AOMinimums
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 16;

                    ;% p5_DW.HILInitialize_AOMaximums
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 24;

                    ;% p5_DW.HILInitialize_AOVoltages
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 32;

                    ;% p5_DW.HILInitialize_FilterFrequency
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 40;

                    ;% p5_DW.HILInitialize_POSortedFreqs
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 48;

                    ;% p5_DW.HILInitialize_POValues
                    section.data(8).logicalSrcIdx = 7;
                    ...
                    ;% p5_DW.LastUAtTimeB_c
                    section.data(16).logicalSrcIdx = 15;
                    section.data(16).dtTransOffset = 74;

                    ;% p5_DW.RateTransition_Buffer
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% p5_DW.HILReadEncoder_PWORK
                    section.data(1).logicalSrcIdx = 18;
                    section.data(1).dtTransOffset = 0;

                    ;% p5_DW.HILWriteAnalog_PWORK
                    section.data(2).logicalSrcIdx = 19;
                    section.data(2).dtTransOffset = 1;

                    ;% p5_DW.MotorCurrentCommands_PWORK.LoggedData
                    section.data(3).logicalSrcIdx = 20;
                    section.data(3).dtTransOffset = 2;

                    ;% p5_DW.HILReadAnalog_PWORK
                    section.data(4).logicalSrcIdx = 21;
                    section.data(4).dtTransOffset = 3;

                    ;% p5_DW.ActualMotorCurrents_PWORK.LoggedData
                    section.data(5).logicalSrcIdx = 22;
                    section.data(5).dtTransOffset = 4;

                    ;% p5_DW.Forces_PWORK.LoggedData
                    section.data(6).logicalSrcIdx = 23;
                    section.data(6).dtTransOffset = 5;

                    ;% p5_DW.ToWorkspace_PWORK.LoggedData
                    section.data(7).logicalSrcIdx = 24;
                    section.data(7).dtTransOffset = 6;

                    ;% p5_DW.MotorCurrent_PWORK.LoggedData
                    section.data(8).logicalSrcIdx = 25;
                    section.data(8).dtTransOffset = 7;

                    ;% p5_DW.Phi_PWORK.LoggedData
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% p5_DW.HILInitialize_ClockModes
                    section.data(1).logicalSrcIdx = 27;
                    section.data(1).dtTransOffset = 0;

                    ;% p5_DW.HILInitialize_QuadratureModes
                    section.data(2).logicalSrcIdx = 28;
                    section.data(2).dtTransOffset = 3;

                    ;% p5_DW.HILInitialize_InitialEICounts
                    section.data(3).logicalSrcIdx = 29;
                    section.data(3).dtTransOffset = 11;

                    ;% p5_DW.HILInitialize_POModeValues
                    section.data(4).logicalSrcIdx = 30;
                    section.data(4).dtTransOffset = 19;

                    ;% p5_DW.HILInitialize_POAlignValues
                    section.data(5).logicalSrcIdx = 31;
                    section.data(5).dtTransOffset = 27;

                    ;% p5_DW.HILInitialize_POPolarityVals
                    section.data(6).logicalSrcIdx = 32;
                    section.data(6).dtTransOffset = 35;

                    ;% p5_DW.HILReadEncoder_Buffer
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% p5_DW.HILInitialize_POSortedChans
    ...
    targMap.checksum0 = 455800688;
    targMap.checksum1 = 3300808064;
    targMap.checksum2 = 1522514097;
    targMap.checksum3 = 910604590;
