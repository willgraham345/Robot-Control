###########################################################################
## Makefile generated for component 'PIControl'. 
## 
## Makefile     : PIControl.mk
## Generated on : Fri Apr 14 12:54:38 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\PIControl.rt-win64
...
COMPILER_COMMAND_FILE     = PIControl_comp.rsp
CMD_FILE                  = PIControl.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\PIControl.rt-win64
...
DEFINES_STANDARD = -DMODEL=PIControl -DNUMST=3 -DNCSTATES=8 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\PIControl_quarc_win64\PIControl.c $(START_DIR)\PIControl_quarc_win64\PIControl_data.c $(START_DIR)\PIControl_quarc_win64\PIControl_main.c $(START_DIR)\PIControl_quarc_win64\rtGetInf.c $(START_DIR)\PIControl_quarc_win64\rtGetNaN.c $(START_DIR)\PIControl_quarc_win64\rt_nonfinite.c $(START_DIR)\PIControl_quarc_win64\rt_zcfcn.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = PIControl.obj PIControl_data.obj PIControl_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_zcfcn.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\PIControl_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\PIControl_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
PIControl.obj : $(START_DIR)\PIControl_quarc_win64\PIControl.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PIControl_quarc_win64\PIControl.c


PIControl_data.obj : $(START_DIR)\PIControl_quarc_win64\PIControl_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PIControl_quarc_win64\PIControl_data.c


PIControl_main.obj : $(START_DIR)\PIControl_quarc_win64\PIControl_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PIControl_quarc_win64\PIControl_main.c


rtGetInf.obj : $(START_DIR)\PIControl_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PIControl_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\PIControl_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PIControl_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\PIControl_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PIControl_quarc_win64\rt_nonfinite.c


rt_zcfcn.obj : $(START_DIR)\PIControl_quarc_win64\rt_zcfcn.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PIControl_quarc_win64\rt_zcfcn.c
