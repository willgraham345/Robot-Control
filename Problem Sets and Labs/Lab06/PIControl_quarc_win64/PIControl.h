...
#ifndef RTW_HEADER_PIControl_h_
#define RTW_HEADER_PIControl_h_
#include <math.h>
#include <string.h>
#ifndef PIControl_COMMON_INCLUDES_
#define PIControl_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* PIControl_COMMON_INCLUDES_ */

#include "PIControl_types.h"
...
#define PIControl_rtModel              RT_MODEL_PIControl_T
...
typedef struct {
  ...
  B_BiasRemoval_PIControl_T BiasRemoval1;/* '<S56>/Bias Removal1' */
  B_BiasRemoval_PIControl_T BiasRemoval;/* '<S56>/Bias Removal' */
} B_PIControl_T;
...
typedef struct {
  ...
  DW_BiasRemoval_PIControl_T BiasRemoval1;/* '<S56>/Bias Removal1' */
  DW_BiasRemoval_PIControl_T BiasRemoval;/* '<S56>/Bias Removal' */
} DW_PIControl_T;
...
#define rtB                            PIControl_B
#define BlockIO                        B_PIControl_T
#define rtX                            PIControl_X
#define ContinuousStates               X_PIControl_T
#define rtXdot                         PIControl_XDot
#define StateDerivatives               XDot_PIControl_T
#define tXdis                          PIControl_XDis
#define StateDisabled                  XDis_PIControl_T
#define rtP                            PIControl_P
#define Parameters                     P_PIControl_T
#define rtDWork                        PIControl_DW
#define D_Work                         DW_PIControl_T
#define rtPrevZCSigState               PIControl_PrevZCX
#define PrevZCSigStates                PrevZCX_PIControl_T

/* Parameters for system: '<S56>/Bias Removal' */
struct P_BiasRemoval_PIControl_T_ {
...
struct P_PIControl_T_ {
  ...
  uint32_T HILReadAnalog_channels_c[2];
                                      ...
                                      */
  real_T IGain_Gain;                   /* Expression: .2
                                        * Referenced by: '<S5>/I Gain'
                                        */
  real_T KfGain_Gain;                  /* Expression: 2.5
  ...
  real_T DGain_Gain[2];                /* Expression: [5 5]
                                        ...
                                        */
  real_T PGain_Gain;                   /* Expression: 90
  ...
  uint8_T XYSuperimposed_Mode;        /* Computed Parameter: XYSuperimposed_Mode
                                       * Referenced by: '<Root>/XY Superimposed'
                                       */
  P_BiasRemoval_PIControl_T BiasRemoval1;/* '<S56>/Bias Removal1' */
  P_BiasRemoval_PIControl_T BiasRemoval;/* '<S56>/Bias Removal' */
};

/* Real-time Model Data Structure */
struct tag_RTM_PIControl_T {
  const char_T *path;
...
extern P_PIControl_T PIControl_P;

/* Block signals (default storage) */
extern B_PIControl_T PIControl_B;

/* Continuous states (default storage) */
extern X_PIControl_T PIControl_X;

/* Block states (default storage) */
extern DW_PIControl_T PIControl_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_PIControl_T PIControl_PrevZCX;
...
extern void PIControl_initialize(void);
extern void PIControl_output0(void);
extern void PIControl_update0(void);
extern void PIControl_output2(void);
extern void PIControl_update2(void);
extern void PIControl_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern PIControl_rtModel *PIControl(void);
...
extern RT_MODEL_PIControl_T *const PIControl_M;
 ...
 *
 * '<Root>' : 'PIControl'
 * '<S1>'   : 'PIControl/Desired Position'
 * '<S2>'   : 'PIControl/Feedback Comp'
 * '<S3>'   : 'PIControl/Jacobian Transpose'
 * '<S4>'   : 'PIControl/Phase 1 Control'
 * '<S5>'   : 'PIControl/Phase 2 Control'
 * '<S6>'   : 'PIControl/Robot and Environment Subsystem'
 * '<S7>'   : 'PIControl/Phase 1 Control/PD Controller'
 * '<S8>'   : 'PIControl/Phase 1 Control/PD Controller/Anti-windup'
 * '<S9>'   : 'PIControl/Phase 1 Control/PD Controller/D Gain'
 * '<S10>'  : 'PIControl/Phase 1 Control/PD Controller/Filter'
 * '<S11>'  : 'PIControl/Phase 1 Control/PD Controller/Filter ICs'
 * '<S12>'  : 'PIControl/Phase 1 Control/PD Controller/I Gain'
 * '<S13>'  : 'PIControl/Phase 1 Control/PD Controller/Ideal P Gain'
 * '<S14>'  : 'PIControl/Phase 1 Control/PD Controller/Ideal P Gain Fdbk'
 * '<S15>'  : 'PIControl/Phase 1 Control/PD Controller/Integrator'
 * '<S16>'  : 'PIControl/Phase 1 Control/PD Controller/Integrator ICs'
 * '<S17>'  : 'PIControl/Phase 1 Control/PD Controller/N Copy'
 * '<S18>'  : 'PIControl/Phase 1 Control/PD Controller/N Gain'
 * '<S19>'  : 'PIControl/Phase 1 Control/PD Controller/P Copy'
 * '<S20>'  : 'PIControl/Phase 1 Control/PD Controller/Parallel P Gain'
 * '<S21>'  : 'PIControl/Phase 1 Control/PD Controller/Reset Signal'
 * '<S22>'  : 'PIControl/Phase 1 Control/PD Controller/Saturation'
 * '<S23>'  : 'PIControl/Phase 1 Control/PD Controller/Saturation Fdbk'
 * '<S24>'  : 'PIControl/Phase 1 Control/PD Controller/Sum'
 * '<S25>'  : 'PIControl/Phase 1 Control/PD Controller/Sum Fdbk'
 * '<S26>'  : 'PIControl/Phase 1 Control/PD Controller/Tracking Mode'
 * '<S27>'  : 'PIControl/Phase 1 Control/PD Controller/Tracking Mode Sum'
 * '<S28>'  : 'PIControl/Phase 1 Control/PD Controller/Tsamp - Integral'
 * '<S29>'  : 'PIControl/Phase 1 Control/PD Controller/Tsamp - Ngain'
 * '<S30>'  : 'PIControl/Phase 1 Control/PD Controller/postSat Signal'
 * '<S31>'  : 'PIControl/Phase 1 Control/PD Controller/preSat Signal'
 * '<S32>'  : 'PIControl/Phase 1 Control/PD Controller/Anti-windup/Disabled'
 * '<S33>'  : 'PIControl/Phase 1 Control/PD Controller/D Gain/Internal Parameters'
 * '<S34>'  : 'PIControl/Phase 1 Control/PD Controller/Filter/Cont. Filter'
 * '<S35>'  : 'PIControl/Phase 1 Control/PD Controller/Filter ICs/Internal IC - Filter'
 * '<S36>'  : 'PIControl/Phase 1 Control/PD Controller/I Gain/Disabled'
 * '<S37>'  : 'PIControl/Phase 1 Control/PD Controller/Ideal P Gain/Passthrough'
 * '<S38>'  : 'PIControl/Phase 1 Control/PD Controller/Ideal P Gain Fdbk/Disabled'
 * '<S39>'  : 'PIControl/Phase 1 Control/PD Controller/Integrator/Disabled'
 * '<S40>'  : 'PIControl/Phase 1 Control/PD Controller/Integrator ICs/Disabled'
 * '<S41>'  : 'PIControl/Phase 1 Control/PD Controller/N Copy/Disabled'
 * '<S42>'  : 'PIControl/Phase 1 Control/PD Controller/N Gain/Internal Parameters'
 * '<S43>'  : 'PIControl/Phase 1 Control/PD Controller/P Copy/Disabled'
 * '<S44>'  : 'PIControl/Phase 1 Control/PD Controller/Parallel P Gain/Internal Parameters'
 * '<S45>'  : 'PIControl/Phase 1 Control/PD Controller/Reset Signal/Disabled'
 * '<S46>'  : 'PIControl/Phase 1 Control/PD Controller/Saturation/Passthrough'
 * '<S47>'  : 'PIControl/Phase 1 Control/PD Controller/Saturation Fdbk/Disabled'
 * '<S48>'  : 'PIControl/Phase 1 Control/PD Controller/Sum/Sum_PD'
 * '<S49>'  : 'PIControl/Phase 1 Control/PD Controller/Sum Fdbk/Disabled'
 * '<S50>'  : 'PIControl/Phase 1 Control/PD Controller/Tracking Mode/Disabled'
 * '<S51>'  : 'PIControl/Phase 1 Control/PD Controller/Tracking Mode Sum/Passthrough'
 * '<S52>'  : 'PIControl/Phase 1 Control/PD Controller/Tsamp - Integral/Disabled wSignal Specification'
 * '<S53>'  : 'PIControl/Phase 1 Control/PD Controller/Tsamp - Ngain/Passthrough'
 * '<S54>'  : 'PIControl/Phase 1 Control/PD Controller/postSat Signal/Forward_Path'
 * '<S55>'  : 'PIControl/Phase 1 Control/PD Controller/preSat Signal/Forward_Path'
 * '<S56>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem'
 * '<S57>'  : 'PIControl/Robot and Environment Subsystem/Forward Kinematics'
 * '<S58>'  : 'PIControl/Robot and Environment Subsystem/Robot Subsystem'
 * '<S59>'  : 'PIControl/Robot and Environment Subsystem/Rotation to Base Frame'
 * '<S60>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal'
 * '<S61>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1'
 * '<S62>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Second-Order Low-Pass Filter'
 * '<S63>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Second-Order Low-Pass Filter1'
 * '<S64>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal/Enabled Moving Average'
 * '<S65>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal/Switch Case Action Subsystem'
 * '<S66>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal/Switch Case Action Subsystem1'
 * '<S67>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal/Switch Case Action Subsystem2'
 * '<S68>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal/Enabled Moving Average/Increment'
 * '<S69>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1/Enabled Moving Average'
 * '<S70>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1/Switch Case Action Subsystem'
 * '<S71>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1/Switch Case Action Subsystem1'
 * '<S72>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1/Switch Case Action Subsystem2'
 * '<S73>'  : 'PIControl/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1/Enabled Moving Average/Increment'
 */
#endif                                 /* RTW_HEADER_PIControl_h_ */
