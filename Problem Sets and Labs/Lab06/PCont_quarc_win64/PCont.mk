###########################################################################
## Makefile generated for component 'PCont'. 
## 
## Makefile     : PCont.mk
## Generated on : Fri Apr 14 12:32:40 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\PCont.rt-win64
...
COMPILER_COMMAND_FILE     = PCont_comp.rsp
CMD_FILE                  = PCont.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\PCont.rt-win64
...
DEFINES_STANDARD = -DMODEL=PCont -DNUMST=3 -DNCSTATES=8 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\PCont_quarc_win64\PCont.c $(START_DIR)\PCont_quarc_win64\PCont_data.c $(START_DIR)\PCont_quarc_win64\PCont_main.c $(START_DIR)\PCont_quarc_win64\rtGetInf.c $(START_DIR)\PCont_quarc_win64\rtGetNaN.c $(START_DIR)\PCont_quarc_win64\rt_nonfinite.c $(START_DIR)\PCont_quarc_win64\rt_zcfcn.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = PCont.obj PCont_data.obj PCont_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_zcfcn.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\PCont_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\PCont_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
PCont.obj : $(START_DIR)\PCont_quarc_win64\PCont.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PCont_quarc_win64\PCont.c


PCont_data.obj : $(START_DIR)\PCont_quarc_win64\PCont_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PCont_quarc_win64\PCont_data.c


PCont_main.obj : $(START_DIR)\PCont_quarc_win64\PCont_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PCont_quarc_win64\PCont_main.c


rtGetInf.obj : $(START_DIR)\PCont_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PCont_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\PCont_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PCont_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\PCont_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PCont_quarc_win64\rt_nonfinite.c


rt_zcfcn.obj : $(START_DIR)\PCont_quarc_win64\rt_zcfcn.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\PCont_quarc_win64\rt_zcfcn.c
