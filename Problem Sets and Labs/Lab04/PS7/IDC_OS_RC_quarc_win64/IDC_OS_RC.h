...
#ifndef RTW_HEADER_IDC_OS_RC_h_
#define RTW_HEADER_IDC_OS_RC_h_
#include <math.h>
#include <string.h>
#ifndef IDC_OS_RC_COMMON_INCLUDES_
#define IDC_OS_RC_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* IDC_OS_RC_COMMON_INCLUDES_ */

#include "IDC_OS_RC_types.h"
...
#define IDC_OS_RC_rtModel              RT_MODEL_IDC_OS_RC_T
...
typedef struct {
  ...
  real_T LastUAtTimeA_m[2];            /* '<Root>/Derivative3' */
  real_T TimeStampB_a;                 /* '<Root>/Derivative3' */
  real_T LastUAtTimeB_p[2];            /* '<Root>/Derivative3' */
...
#define rtB                            IDC_OS_RC_B
#define BlockIO                        B_IDC_OS_RC_T
#define rtX                            IDC_OS_RC_X
#define ContinuousStates               X_IDC_OS_RC_T
#define rtXdot                         IDC_OS_RC_XDot
#define StateDerivatives               XDot_IDC_OS_RC_T
#define tXdis                          IDC_OS_RC_XDis
#define StateDisabled                  XDis_IDC_OS_RC_T
#define rtP                            IDC_OS_RC_P
#define Parameters                     P_IDC_OS_RC_T
#define rtDWork                        IDC_OS_RC_DW
#define D_Work                         DW_IDC_OS_RC_T

/* Parameters (default storage) */
struct P_IDC_OS_RC_T_ {
...
extern P_IDC_OS_RC_T IDC_OS_RC_P;

/* Block signals (default storage) */
extern B_IDC_OS_RC_T IDC_OS_RC_B;

/* Continuous states (default storage) */
extern X_IDC_OS_RC_T IDC_OS_RC_X;

/* Block states (default storage) */
extern DW_IDC_OS_RC_T IDC_OS_RC_DW;
...
extern void IDC_OS_RC_initialize(void);
extern void IDC_OS_RC_output0(void);
extern void IDC_OS_RC_update0(void);
extern void IDC_OS_RC_output2(void);
extern void IDC_OS_RC_update2(void);
extern void IDC_OS_RC_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern IDC_OS_RC_rtModel *IDC_OS_RC(void);
...
extern RT_MODEL_IDC_OS_RC_T *const IDC_OS_RC_M;
 ...
 *
 * '<Root>' : 'IDC_OS_RC'
 * '<S1>'   : 'IDC_OS_RC/Feedback Comp'
 * '<S2>'   : 'IDC_OS_RC/Forward Kinematics'
 * '<S3>'   : 'IDC_OS_RC/Hx Matrix'
 * '<S4>'   : 'IDC_OS_RC/Jacobian Transpose'
 * '<S5>'   : 'IDC_OS_RC/Jacobiandot'
 * '<S6>'   : 'IDC_OS_RC/PID Controller'
 * '<S7>'   : 'IDC_OS_RC/Robot Subsystem'
 * '<S8>'   : 'IDC_OS_RC/Trajectory  Generator'
 * '<S9>'   : 'IDC_OS_RC/XY Plotter'
 * '<S10>'  : 'IDC_OS_RC/PID Controller/Anti-windup'
 * '<S11>'  : 'IDC_OS_RC/PID Controller/D Gain'
 * '<S12>'  : 'IDC_OS_RC/PID Controller/Filter'
 * '<S13>'  : 'IDC_OS_RC/PID Controller/Filter ICs'
 * '<S14>'  : 'IDC_OS_RC/PID Controller/I Gain'
 * '<S15>'  : 'IDC_OS_RC/PID Controller/Ideal P Gain'
 * '<S16>'  : 'IDC_OS_RC/PID Controller/Ideal P Gain Fdbk'
 * '<S17>'  : 'IDC_OS_RC/PID Controller/Integrator'
 * '<S18>'  : 'IDC_OS_RC/PID Controller/Integrator ICs'
 * '<S19>'  : 'IDC_OS_RC/PID Controller/N Copy'
 * '<S20>'  : 'IDC_OS_RC/PID Controller/N Gain'
 * '<S21>'  : 'IDC_OS_RC/PID Controller/P Copy'
 * '<S22>'  : 'IDC_OS_RC/PID Controller/Parallel P Gain'
 * '<S23>'  : 'IDC_OS_RC/PID Controller/Reset Signal'
 * '<S24>'  : 'IDC_OS_RC/PID Controller/Saturation'
 * '<S25>'  : 'IDC_OS_RC/PID Controller/Saturation Fdbk'
 * '<S26>'  : 'IDC_OS_RC/PID Controller/Sum'
 * '<S27>'  : 'IDC_OS_RC/PID Controller/Sum Fdbk'
 * '<S28>'  : 'IDC_OS_RC/PID Controller/Tracking Mode'
 * '<S29>'  : 'IDC_OS_RC/PID Controller/Tracking Mode Sum'
 * '<S30>'  : 'IDC_OS_RC/PID Controller/Tsamp - Integral'
 * '<S31>'  : 'IDC_OS_RC/PID Controller/Tsamp - Ngain'
 * '<S32>'  : 'IDC_OS_RC/PID Controller/postSat Signal'
 * '<S33>'  : 'IDC_OS_RC/PID Controller/preSat Signal'
 * '<S34>'  : 'IDC_OS_RC/PID Controller/Anti-windup/Disabled'
 * '<S35>'  : 'IDC_OS_RC/PID Controller/D Gain/Internal Parameters'
 * '<S36>'  : 'IDC_OS_RC/PID Controller/Filter/Cont. Filter'
 * '<S37>'  : 'IDC_OS_RC/PID Controller/Filter ICs/Internal IC - Filter'
 * '<S38>'  : 'IDC_OS_RC/PID Controller/I Gain/Disabled'
 * '<S39>'  : 'IDC_OS_RC/PID Controller/Ideal P Gain/Passthrough'
 * '<S40>'  : 'IDC_OS_RC/PID Controller/Ideal P Gain Fdbk/Disabled'
 * '<S41>'  : 'IDC_OS_RC/PID Controller/Integrator/Disabled'
 * '<S42>'  : 'IDC_OS_RC/PID Controller/Integrator ICs/Disabled'
 * '<S43>'  : 'IDC_OS_RC/PID Controller/N Copy/Disabled'
 * '<S44>'  : 'IDC_OS_RC/PID Controller/N Gain/Internal Parameters'
 * '<S45>'  : 'IDC_OS_RC/PID Controller/P Copy/Disabled'
 * '<S46>'  : 'IDC_OS_RC/PID Controller/Parallel P Gain/Internal Parameters'
 * '<S47>'  : 'IDC_OS_RC/PID Controller/Reset Signal/Disabled'
 * '<S48>'  : 'IDC_OS_RC/PID Controller/Saturation/Passthrough'
 * '<S49>'  : 'IDC_OS_RC/PID Controller/Saturation Fdbk/Disabled'
 * '<S50>'  : 'IDC_OS_RC/PID Controller/Sum/Sum_PD'
 * '<S51>'  : 'IDC_OS_RC/PID Controller/Sum Fdbk/Disabled'
 * '<S52>'  : 'IDC_OS_RC/PID Controller/Tracking Mode/Disabled'
 * '<S53>'  : 'IDC_OS_RC/PID Controller/Tracking Mode Sum/Passthrough'
 * '<S54>'  : 'IDC_OS_RC/PID Controller/Tsamp - Integral/Disabled wSignal Specification'
 * '<S55>'  : 'IDC_OS_RC/PID Controller/Tsamp - Ngain/Passthrough'
 * '<S56>'  : 'IDC_OS_RC/PID Controller/postSat Signal/Forward_Path'
 * '<S57>'  : 'IDC_OS_RC/PID Controller/preSat Signal/Forward_Path'
 */
#endif                                 /* RTW_HEADER_IDC_OS_RC_h_ */
