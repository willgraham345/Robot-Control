###########################################################################
## Makefile generated for component 'IDC_OS_RC'. 
## 
## Makefile     : IDC_OS_RC.mk
## Generated on : Sat Apr 01 13:22:45 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\IDC_OS_RC.rt-win64
...
COMPILER_COMMAND_FILE     = IDC_OS_RC_comp.rsp
CMD_FILE                  = IDC_OS_RC.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\IDC_OS_RC.rt-win64
...
DEFINES_STANDARD = -DMODEL=IDC_OS_RC -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\IDC_OS_RC_quarc_win64\IDC_OS_RC.c $(START_DIR)\IDC_OS_RC_quarc_win64\IDC_OS_RC_data.c $(START_DIR)\IDC_OS_RC_quarc_win64\IDC_OS_RC_main.c $(START_DIR)\IDC_OS_RC_quarc_win64\rtGetInf.c $(START_DIR)\IDC_OS_RC_quarc_win64\rtGetNaN.c $(START_DIR)\IDC_OS_RC_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = IDC_OS_RC.obj IDC_OS_RC_data.obj IDC_OS_RC_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\IDC_OS_RC_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\IDC_OS_RC_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
IDC_OS_RC.obj : $(START_DIR)\IDC_OS_RC_quarc_win64\IDC_OS_RC.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\IDC_OS_RC_quarc_win64\IDC_OS_RC.c


IDC_OS_RC_data.obj : $(START_DIR)\IDC_OS_RC_quarc_win64\IDC_OS_RC_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\IDC_OS_RC_quarc_win64\IDC_OS_RC_data.c


IDC_OS_RC_main.obj : $(START_DIR)\IDC_OS_RC_quarc_win64\IDC_OS_RC_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\IDC_OS_RC_quarc_win64\IDC_OS_RC_main.c


rtGetInf.obj : $(START_DIR)\IDC_OS_RC_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\IDC_OS_RC_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\IDC_OS_RC_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\IDC_OS_RC_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\IDC_OS_RC_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\IDC_OS_RC_quarc_win64\rt_nonfinite.c
