...
#ifndef RTW_HEADER_JacInvCont_h_
#define RTW_HEADER_JacInvCont_h_
#include <math.h>
#include <string.h>
#ifndef JacInvCont_COMMON_INCLUDES_
#define JacInvCont_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* JacInvCont_COMMON_INCLUDES_ */

#include "JacInvCont_types.h"
...
#define JacInvCont_rtModel             RT_MODEL_JacInvCont_T
...
typedef struct {
  ...
  real_T phi_err[2];                   /* '<Root>/Inverse Jacobian1' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } ToWorkspace1_PWORK_i;              /* '<S6>/To Workspace1' */
...
#define rtB                            JacInvCont_B
#define BlockIO                        B_JacInvCont_T
#define rtX                            JacInvCont_X
#define ContinuousStates               X_JacInvCont_T
#define rtXdot                         JacInvCont_XDot
#define StateDerivatives               XDot_JacInvCont_T
#define tXdis                          JacInvCont_XDis
#define StateDisabled                  XDis_JacInvCont_T
#define rtP                            JacInvCont_P
#define Parameters                     P_JacInvCont_T
#define rtDWork                        JacInvCont_DW
#define D_Work                         DW_JacInvCont_T

/* Parameters (default storage) */
struct P_JacInvCont_T_ {
...
extern P_JacInvCont_T JacInvCont_P;

/* Block signals (default storage) */
extern B_JacInvCont_T JacInvCont_B;

/* Continuous states (default storage) */
extern X_JacInvCont_T JacInvCont_X;

/* Block states (default storage) */
extern DW_JacInvCont_T JacInvCont_DW;
...
extern void JacInvCont_initialize(void);
extern void JacInvCont_output0(void);
extern void JacInvCont_update0(void);
extern void JacInvCont_output2(void);
extern void JacInvCont_update2(void);
extern void JacInvCont_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern JacInvCont_rtModel *JacInvCont(void);
...
extern RT_MODEL_JacInvCont_T *const JacInvCont_M;
 ...
 *
 * '<Root>' : 'JacInvCont'
 * '<S1>'   : 'JacInvCont/Forward Kinematics'
 * '<S2>'   : 'JacInvCont/Inverse Jacobian1'
 * '<S3>'   : 'JacInvCont/PD Controller'
 * '<S4>'   : 'JacInvCont/Robot Subsystem'
 * '<S5>'   : 'JacInvCont/Trajectory  Generator'
 * '<S6>'   : 'JacInvCont/XY Plotter'
 * '<S7>'   : 'JacInvCont/PD Controller/Anti-windup'
 * '<S8>'   : 'JacInvCont/PD Controller/D Gain'
 * '<S9>'   : 'JacInvCont/PD Controller/Filter'
 * '<S10>'  : 'JacInvCont/PD Controller/Filter ICs'
 * '<S11>'  : 'JacInvCont/PD Controller/I Gain'
 * '<S12>'  : 'JacInvCont/PD Controller/Ideal P Gain'
 * '<S13>'  : 'JacInvCont/PD Controller/Ideal P Gain Fdbk'
 * '<S14>'  : 'JacInvCont/PD Controller/Integrator'
 * '<S15>'  : 'JacInvCont/PD Controller/Integrator ICs'
 * '<S16>'  : 'JacInvCont/PD Controller/N Copy'
 * '<S17>'  : 'JacInvCont/PD Controller/N Gain'
 * '<S18>'  : 'JacInvCont/PD Controller/P Copy'
 * '<S19>'  : 'JacInvCont/PD Controller/Parallel P Gain'
 * '<S20>'  : 'JacInvCont/PD Controller/Reset Signal'
 * '<S21>'  : 'JacInvCont/PD Controller/Saturation'
 * '<S22>'  : 'JacInvCont/PD Controller/Saturation Fdbk'
 * '<S23>'  : 'JacInvCont/PD Controller/Sum'
 * '<S24>'  : 'JacInvCont/PD Controller/Sum Fdbk'
 * '<S25>'  : 'JacInvCont/PD Controller/Tracking Mode'
 * '<S26>'  : 'JacInvCont/PD Controller/Tracking Mode Sum'
 * '<S27>'  : 'JacInvCont/PD Controller/Tsamp - Integral'
 * '<S28>'  : 'JacInvCont/PD Controller/Tsamp - Ngain'
 * '<S29>'  : 'JacInvCont/PD Controller/postSat Signal'
 * '<S30>'  : 'JacInvCont/PD Controller/preSat Signal'
 * '<S31>'  : 'JacInvCont/PD Controller/Anti-windup/Disabled'
 * '<S32>'  : 'JacInvCont/PD Controller/D Gain/Internal Parameters'
 * '<S33>'  : 'JacInvCont/PD Controller/Filter/Cont. Filter'
 * '<S34>'  : 'JacInvCont/PD Controller/Filter ICs/Internal IC - Filter'
 * '<S35>'  : 'JacInvCont/PD Controller/I Gain/Disabled'
 * '<S36>'  : 'JacInvCont/PD Controller/Ideal P Gain/Passthrough'
 * '<S37>'  : 'JacInvCont/PD Controller/Ideal P Gain Fdbk/Disabled'
 * '<S38>'  : 'JacInvCont/PD Controller/Integrator/Disabled'
 * '<S39>'  : 'JacInvCont/PD Controller/Integrator ICs/Disabled'
 * '<S40>'  : 'JacInvCont/PD Controller/N Copy/Disabled'
 * '<S41>'  : 'JacInvCont/PD Controller/N Gain/Internal Parameters'
 * '<S42>'  : 'JacInvCont/PD Controller/P Copy/Disabled'
 * '<S43>'  : 'JacInvCont/PD Controller/Parallel P Gain/Internal Parameters'
 * '<S44>'  : 'JacInvCont/PD Controller/Reset Signal/Disabled'
 * '<S45>'  : 'JacInvCont/PD Controller/Saturation/Passthrough'
 * '<S46>'  : 'JacInvCont/PD Controller/Saturation Fdbk/Disabled'
 * '<S47>'  : 'JacInvCont/PD Controller/Sum/Sum_PD'
 * '<S48>'  : 'JacInvCont/PD Controller/Sum Fdbk/Disabled'
 * '<S49>'  : 'JacInvCont/PD Controller/Tracking Mode/Disabled'
 * '<S50>'  : 'JacInvCont/PD Controller/Tracking Mode Sum/Passthrough'
 * '<S51>'  : 'JacInvCont/PD Controller/Tsamp - Integral/Disabled wSignal Specification'
 * '<S52>'  : 'JacInvCont/PD Controller/Tsamp - Ngain/Passthrough'
 * '<S53>'  : 'JacInvCont/PD Controller/postSat Signal/Forward_Path'
 * '<S54>'  : 'JacInvCont/PD Controller/preSat Signal/Forward_Path'
 */
#endif                                 /* RTW_HEADER_JacInvCont_h_ */
