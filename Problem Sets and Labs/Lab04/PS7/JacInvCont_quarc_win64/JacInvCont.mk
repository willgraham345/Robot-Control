###########################################################################
## Makefile generated for component 'JacInvCont'. 
## 
## Makefile     : JacInvCont.mk
## Generated on : Sat Apr 01 12:42:07 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\JacInvCont.rt-win64
...
COMPILER_COMMAND_FILE     = JacInvCont_comp.rsp
CMD_FILE                  = JacInvCont.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\JacInvCont.rt-win64
...
DEFINES_STANDARD = -DMODEL=JacInvCont -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\JacInvCont_quarc_win64\JacInvCont.c $(START_DIR)\JacInvCont_quarc_win64\JacInvCont_data.c $(START_DIR)\JacInvCont_quarc_win64\JacInvCont_main.c $(START_DIR)\JacInvCont_quarc_win64\rtGetInf.c $(START_DIR)\JacInvCont_quarc_win64\rtGetNaN.c $(START_DIR)\JacInvCont_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = JacInvCont.obj JacInvCont_data.obj JacInvCont_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\JacInvCont_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\JacInvCont_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
JacInvCont.obj : $(START_DIR)\JacInvCont_quarc_win64\JacInvCont.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacInvCont_quarc_win64\JacInvCont.c


JacInvCont_data.obj : $(START_DIR)\JacInvCont_quarc_win64\JacInvCont_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacInvCont_quarc_win64\JacInvCont_data.c


JacInvCont_main.obj : $(START_DIR)\JacInvCont_quarc_win64\JacInvCont_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacInvCont_quarc_win64\JacInvCont_main.c


rtGetInf.obj : $(START_DIR)\JacInvCont_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacInvCont_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\JacInvCont_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacInvCont_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\JacInvCont_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacInvCont_quarc_win64\rt_nonfinite.c
