###########################################################################
## Makefile generated for component 'JacTransCont'. 
## 
## Makefile     : JacTransCont.mk
## Generated on : Sat Apr 01 12:55:43 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\JacTransCont.rt-win64
...
COMPILER_COMMAND_FILE     = JacTransCont_comp.rsp
CMD_FILE                  = JacTransCont.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\JacTransCont.rt-win64
...
DEFINES_STANDARD = -DMODEL=JacTransCont -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\JacTransCont_quarc_win64\JacTransCont.c $(START_DIR)\JacTransCont_quarc_win64\JacTransCont_data.c $(START_DIR)\JacTransCont_quarc_win64\JacTransCont_main.c $(START_DIR)\JacTransCont_quarc_win64\rtGetInf.c $(START_DIR)\JacTransCont_quarc_win64\rtGetNaN.c $(START_DIR)\JacTransCont_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = JacTransCont.obj JacTransCont_data.obj JacTransCont_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\JacTransCont_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\JacTransCont_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
JacTransCont.obj : $(START_DIR)\JacTransCont_quarc_win64\JacTransCont.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacTransCont_quarc_win64\JacTransCont.c


JacTransCont_data.obj : $(START_DIR)\JacTransCont_quarc_win64\JacTransCont_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacTransCont_quarc_win64\JacTransCont_data.c


JacTransCont_main.obj : $(START_DIR)\JacTransCont_quarc_win64\JacTransCont_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacTransCont_quarc_win64\JacTransCont_main.c


rtGetInf.obj : $(START_DIR)\JacTransCont_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacTransCont_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\JacTransCont_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacTransCont_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\JacTransCont_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\JacTransCont_quarc_win64\rt_nonfinite.c
