...
#ifndef RTW_HEADER_JacTransCont_h_
#define RTW_HEADER_JacTransCont_h_
#include <math.h>
#include <string.h>
#ifndef JacTransCont_COMMON_INCLUDES_
#define JacTransCont_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* JacTransCont_COMMON_INCLUDES_ */

#include "JacTransCont_types.h"
...
#define JacTransCont_rtModel           RT_MODEL_JacTransCont_T
...
typedef struct {
  ...
  real_T tau[2];                       /* '<Root>/Jacobian  Transpose' */
...
#define rtB                            JacTransCont_B
#define BlockIO                        B_JacTransCont_T
#define rtX                            JacTransCont_X
#define ContinuousStates               X_JacTransCont_T
#define rtXdot                         JacTransCont_XDot
#define StateDerivatives               XDot_JacTransCont_T
#define tXdis                          JacTransCont_XDis
#define StateDisabled                  XDis_JacTransCont_T
#define rtP                            JacTransCont_P
#define Parameters                     P_JacTransCont_T
#define rtDWork                        JacTransCont_DW
#define D_Work                         DW_JacTransCont_T

/* Parameters (default storage) */
struct P_JacTransCont_T_ {
...
extern P_JacTransCont_T JacTransCont_P;

/* Block signals (default storage) */
extern B_JacTransCont_T JacTransCont_B;

/* Continuous states (default storage) */
extern X_JacTransCont_T JacTransCont_X;

/* Block states (default storage) */
extern DW_JacTransCont_T JacTransCont_DW;
...
extern void JacTransCont_initialize(void);
extern void JacTransCont_output0(void);
extern void JacTransCont_update0(void);
extern void JacTransCont_output2(void);
extern void JacTransCont_update2(void);
extern void JacTransCont_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern JacTransCont_rtModel *JacTransCont(void);
...
extern RT_MODEL_JacTransCont_T *const JacTransCont_M;
 ...
 *
 * '<Root>' : 'JacTransCont'
 * '<S1>'   : 'JacTransCont/Forward Kinematics'
 * '<S2>'   : 'JacTransCont/Jacobian  Transpose'
 * '<S3>'   : 'JacTransCont/PID Controller'
 * '<S4>'   : 'JacTransCont/Robot Subsystem'
 * '<S5>'   : 'JacTransCont/Trajectory  Generator'
 * '<S6>'   : 'JacTransCont/XY Plotter'
 * '<S7>'   : 'JacTransCont/PID Controller/Anti-windup'
 * '<S8>'   : 'JacTransCont/PID Controller/D Gain'
 * '<S9>'   : 'JacTransCont/PID Controller/Filter'
 * '<S10>'  : 'JacTransCont/PID Controller/Filter ICs'
 * '<S11>'  : 'JacTransCont/PID Controller/I Gain'
 * '<S12>'  : 'JacTransCont/PID Controller/Ideal P Gain'
 * '<S13>'  : 'JacTransCont/PID Controller/Ideal P Gain Fdbk'
 * '<S14>'  : 'JacTransCont/PID Controller/Integrator'
 * '<S15>'  : 'JacTransCont/PID Controller/Integrator ICs'
 * '<S16>'  : 'JacTransCont/PID Controller/N Copy'
 * '<S17>'  : 'JacTransCont/PID Controller/N Gain'
 * '<S18>'  : 'JacTransCont/PID Controller/P Copy'
 * '<S19>'  : 'JacTransCont/PID Controller/Parallel P Gain'
 * '<S20>'  : 'JacTransCont/PID Controller/Reset Signal'
 * '<S21>'  : 'JacTransCont/PID Controller/Saturation'
 * '<S22>'  : 'JacTransCont/PID Controller/Saturation Fdbk'
 * '<S23>'  : 'JacTransCont/PID Controller/Sum'
 * '<S24>'  : 'JacTransCont/PID Controller/Sum Fdbk'
 * '<S25>'  : 'JacTransCont/PID Controller/Tracking Mode'
 * '<S26>'  : 'JacTransCont/PID Controller/Tracking Mode Sum'
 * '<S27>'  : 'JacTransCont/PID Controller/Tsamp - Integral'
 * '<S28>'  : 'JacTransCont/PID Controller/Tsamp - Ngain'
 * '<S29>'  : 'JacTransCont/PID Controller/postSat Signal'
 * '<S30>'  : 'JacTransCont/PID Controller/preSat Signal'
 * '<S31>'  : 'JacTransCont/PID Controller/Anti-windup/Disabled'
 * '<S32>'  : 'JacTransCont/PID Controller/D Gain/Internal Parameters'
 * '<S33>'  : 'JacTransCont/PID Controller/Filter/Cont. Filter'
 * '<S34>'  : 'JacTransCont/PID Controller/Filter ICs/Internal IC - Filter'
 * '<S35>'  : 'JacTransCont/PID Controller/I Gain/Disabled'
 * '<S36>'  : 'JacTransCont/PID Controller/Ideal P Gain/Passthrough'
 * '<S37>'  : 'JacTransCont/PID Controller/Ideal P Gain Fdbk/Disabled'
 * '<S38>'  : 'JacTransCont/PID Controller/Integrator/Disabled'
 * '<S39>'  : 'JacTransCont/PID Controller/Integrator ICs/Disabled'
 * '<S40>'  : 'JacTransCont/PID Controller/N Copy/Disabled'
 * '<S41>'  : 'JacTransCont/PID Controller/N Gain/Internal Parameters'
 * '<S42>'  : 'JacTransCont/PID Controller/P Copy/Disabled'
 * '<S43>'  : 'JacTransCont/PID Controller/Parallel P Gain/Internal Parameters'
 * '<S44>'  : 'JacTransCont/PID Controller/Reset Signal/Disabled'
 * '<S45>'  : 'JacTransCont/PID Controller/Saturation/Passthrough'
 * '<S46>'  : 'JacTransCont/PID Controller/Saturation Fdbk/Disabled'
 * '<S47>'  : 'JacTransCont/PID Controller/Sum/Sum_PD'
 * '<S48>'  : 'JacTransCont/PID Controller/Sum Fdbk/Disabled'
 * '<S49>'  : 'JacTransCont/PID Controller/Tracking Mode/Disabled'
 * '<S50>'  : 'JacTransCont/PID Controller/Tracking Mode Sum/Passthrough'
 * '<S51>'  : 'JacTransCont/PID Controller/Tsamp - Integral/Disabled wSignal Specification'
 * '<S52>'  : 'JacTransCont/PID Controller/Tsamp - Ngain/Passthrough'
 * '<S53>'  : 'JacTransCont/PID Controller/postSat Signal/Forward_Path'
 * '<S54>'  : 'JacTransCont/PID Controller/preSat Signal/Forward_Path'
 */
#endif                                 /* RTW_HEADER_JacTransCont_h_ */
