###########################################################################
## Makefile generated for component 'Q3Lab1RobotControl'. 
## 
## Makefile     : Q3Lab1RobotControl.mk
## Generated on : Sat Mar 11 13:12:24 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Q3Lab1RobotControl.rt-win64
...
PRODUCT_NAME              = Q3Lab1RobotControl
MAKEFILE                  = Q3Lab1RobotControl.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\STUDEN~1\DOCUME~1\MATLAB\ORTON_~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Q3Lab1RobotControl_comp.rsp
CMD_FILE                  = Q3Lab1RobotControl.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Q3Lab1RobotControl.rt-win64
...
DEFINES_STANDARD = -DMODEL=Q3Lab1RobotControl -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Q3Lab1RobotControl_quarc_win64\Q3Lab1RobotControl.c $(START_DIR)\Q3Lab1RobotControl_quarc_win64\Q3Lab1RobotControl_data.c $(START_DIR)\Q3Lab1RobotControl_quarc_win64\Q3Lab1RobotControl_main.c $(START_DIR)\Q3Lab1RobotControl_quarc_win64\rtGetInf.c $(START_DIR)\Q3Lab1RobotControl_quarc_win64\rtGetNaN.c $(START_DIR)\Q3Lab1RobotControl_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Q3Lab1RobotControl.obj Q3Lab1RobotControl_data.obj Q3Lab1RobotControl_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Q3Lab1RobotControl_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Q3Lab1RobotControl_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Q3Lab1RobotControl.obj : $(START_DIR)\Q3Lab1RobotControl_quarc_win64\Q3Lab1RobotControl.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Q3Lab1RobotControl_quarc_win64\Q3Lab1RobotControl.c


Q3Lab1RobotControl_data.obj : $(START_DIR)\Q3Lab1RobotControl_quarc_win64\Q3Lab1RobotControl_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Q3Lab1RobotControl_quarc_win64\Q3Lab1RobotControl_data.c


Q3Lab1RobotControl_main.obj : $(START_DIR)\Q3Lab1RobotControl_quarc_win64\Q3Lab1RobotControl_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Q3Lab1RobotControl_quarc_win64\Q3Lab1RobotControl_main.c


rtGetInf.obj : $(START_DIR)\Q3Lab1RobotControl_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Q3Lab1RobotControl_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\Q3Lab1RobotControl_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Q3Lab1RobotControl_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\Q3Lab1RobotControl_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Q3Lab1RobotControl_quarc_win64\rt_nonfinite.c
