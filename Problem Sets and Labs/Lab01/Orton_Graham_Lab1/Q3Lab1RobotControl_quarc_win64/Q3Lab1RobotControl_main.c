...
typedef RT_MODEL_Q3Lab1RobotControl_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Q3Lab1RobotControl(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Q3Lab1RobotControl_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Q3Lab1RobotControl -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
