...
typedef RT_MODEL_Q2Lab1RobotControl_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Q2Lab1RobotControl(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Q2Lab1RobotControl_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Q2Lab1RobotControl -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
