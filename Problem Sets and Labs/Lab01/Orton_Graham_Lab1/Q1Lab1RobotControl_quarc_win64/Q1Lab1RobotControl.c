...
RT_MODEL_Q1Lab1RobotControl_T *Q1Lab1RobotControl(void)
{
  ...
  /* External mode info */
  Q1Lab1RobotControl_M->Sizes.checksums[0] = (2944249297U);
  Q1Lab1RobotControl_M->Sizes.checksums[1] = (1441679709U);
  Q1Lab1RobotControl_M->Sizes.checksums[2] = (45113982U);
  Q1Lab1RobotControl_M->Sizes.checksums[3] = (2745976668U);
