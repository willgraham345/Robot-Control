###########################################################################
## Makefile generated for component 'Lab_1_Q2'. 
## 
## Makefile     : Lab_1_Q2.mk
## Generated on : Sat Mar 11 12:40:35 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Lab_1_Q2.rt-win64
...
COMPILER_COMMAND_FILE     = Lab_1_Q2_comp.rsp
CMD_FILE                  = Lab_1_Q2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Lab_1_Q2.rt-win64
...
DEFINES_STANDARD = -DMODEL=Lab_1_Q2 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Lab_1_Q2_quarc_win64\Lab_1_Q2.c $(START_DIR)\Lab_1_Q2_quarc_win64\Lab_1_Q2_data.c $(START_DIR)\Lab_1_Q2_quarc_win64\Lab_1_Q2_main.c $(START_DIR)\Lab_1_Q2_quarc_win64\rtGetInf.c $(START_DIR)\Lab_1_Q2_quarc_win64\rtGetNaN.c $(START_DIR)\Lab_1_Q2_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Lab_1_Q2.obj Lab_1_Q2_data.obj Lab_1_Q2_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Lab_1_Q2_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Lab_1_Q2_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Lab_1_Q2.obj : $(START_DIR)\Lab_1_Q2_quarc_win64\Lab_1_Q2.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Lab_1_Q2_quarc_win64\Lab_1_Q2.c


Lab_1_Q2_data.obj : $(START_DIR)\Lab_1_Q2_quarc_win64\Lab_1_Q2_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Lab_1_Q2_quarc_win64\Lab_1_Q2_data.c


Lab_1_Q2_main.obj : $(START_DIR)\Lab_1_Q2_quarc_win64\Lab_1_Q2_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Lab_1_Q2_quarc_win64\Lab_1_Q2_main.c


rtGetInf.obj : $(START_DIR)\Lab_1_Q2_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Lab_1_Q2_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\Lab_1_Q2_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Lab_1_Q2_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\Lab_1_Q2_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Lab_1_Q2_quarc_win64\rt_nonfinite.c
