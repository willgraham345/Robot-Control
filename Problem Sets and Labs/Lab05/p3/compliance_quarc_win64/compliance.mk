###########################################################################
## Makefile generated for component 'compliance'. 
## 
## Makefile     : compliance.mk
## Generated on : Thu Apr 06 13:51:58 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\compliance.rt-win64
...
START_DIR                 = C:\Users\STUDEN~1\DOCUME~1\ORTONG~1\p3
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = compliance_comp.rsp
CMD_FILE                  = compliance.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\compliance.rt-win64
...
DEFINES_STANDARD = -DMODEL=compliance -DNUMST=3 -DNCSTATES=8 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\compliance_quarc_win64\compliance.c $(START_DIR)\compliance_quarc_win64\compliance_data.c $(START_DIR)\compliance_quarc_win64\compliance_main.c $(START_DIR)\compliance_quarc_win64\rtGetInf.c $(START_DIR)\compliance_quarc_win64\rtGetNaN.c $(START_DIR)\compliance_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = compliance.obj compliance_data.obj compliance_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\compliance_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\compliance_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
compliance.obj : $(START_DIR)\compliance_quarc_win64\compliance.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\compliance_quarc_win64\compliance.c


compliance_data.obj : $(START_DIR)\compliance_quarc_win64\compliance_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\compliance_quarc_win64\compliance_data.c


compliance_main.obj : $(START_DIR)\compliance_quarc_win64\compliance_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\compliance_quarc_win64\compliance_main.c


rtGetInf.obj : $(START_DIR)\compliance_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\compliance_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\compliance_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\compliance_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\compliance_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\compliance_quarc_win64\rt_nonfinite.c
