...
#ifndef RTW_HEADER_Lab5_template2023_h_
#define RTW_HEADER_Lab5_template2023_h_
#include <math.h>
#include <string.h>
#ifndef Lab5_template2023_COMMON_INCLUDES_
#define Lab5_template2023_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Lab5_template2023_COMMON_INCLUDES_ */

#include "Lab5_template2023_types.h"
...
#define Lab5_template2023_rtModel      RT_MODEL_Lab5_template2023_T
...
typedef struct {
  ...
  real_T Sum;                          /* '<S63>/Sum' */
  real_T div;                          /* '<S63>/div' */
} B_BiasRemoval_Lab5_template20_T;
...
} DW_BiasRemoval_Lab5_template2_T;
...
typedef struct {
  ...
  B_BiasRemoval_Lab5_template20_T BiasRemoval1;/* '<S55>/Bias Removal1' */
  B_BiasRemoval_Lab5_template20_T BiasRemoval;/* '<S55>/Bias Removal' */
} B_Lab5_template2023_T;
...
typedef struct {
  ...
  DW_BiasRemoval_Lab5_template2_T BiasRemoval1;/* '<S55>/Bias Removal1' */
  DW_BiasRemoval_Lab5_template2_T BiasRemoval;/* '<S55>/Bias Removal' */
} DW_Lab5_template2023_T;
...
#define rtB                            Lab5_template2023_B
#define BlockIO                        B_Lab5_template2023_T
#define rtX                            Lab5_template2023_X
#define ContinuousStates               X_Lab5_template2023_T
#define rtXdot                         Lab5_template2023_XDot
#define StateDerivatives               XDot_Lab5_template2023_T
#define tXdis                          Lab5_template2023_XDis
#define StateDisabled                  XDis_Lab5_template2023_T
#define rtP                            Lab5_template2023_P
#define Parameters                     P_Lab5_template2023_T
#define rtDWork                        Lab5_template2023_DW
#define D_Work                         DW_Lab5_template2023_T

/* Parameters for system: '<S55>/Bias Removal' */
struct P_BiasRemoval_Lab5_template20_T_ {
...
struct P_Lab5_template2023_T_ {
  ...
  uint8_T XYSuperimposed_Mode;        /* Computed Parameter: XYSuperimposed_Mode
                                       * Referenced by: '<S6>/XY Superimposed'
                                       */
  P_BiasRemoval_Lab5_template20_T BiasRemoval1;/* '<S55>/Bias Removal1' */
  P_BiasRemoval_Lab5_template20_T BiasRemoval;/* '<S55>/Bias Removal' */
};

/* Real-time Model Data Structure */
struct tag_RTM_Lab5_template2023_T {
  const char_T *path;
...
extern P_Lab5_template2023_T Lab5_template2023_P;

/* Block signals (default storage) */
extern B_Lab5_template2023_T Lab5_template2023_B;

/* Continuous states (default storage) */
extern X_Lab5_template2023_T Lab5_template2023_X;

/* Block states (default storage) */
extern DW_Lab5_template2023_T Lab5_template2023_DW;
...
extern void Lab5_template2023_initialize(void);
extern void Lab5_template2023_output0(void);
extern void Lab5_template2023_update0(void);
extern void Lab5_template2023_output2(void);
extern void Lab5_template2023_update2(void);
extern void Lab5_template2023_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Lab5_template2023_rtModel *Lab5_template2023(void);
...
extern RT_MODEL_Lab5_template2023_T *const Lab5_template2023_M;
 ...
 *
 * '<Root>' : 'Lab5_template2023'
 * '<S1>'   : 'Lab5_template2023/Feedback Comp'
 * '<S2>'   : 'Lab5_template2023/Jacobian Transpose'
 * '<S3>'   : 'Lab5_template2023/PD Controller'
 * '<S4>'   : 'Lab5_template2023/Robot and Environment Subsystem'
 * '<S5>'   : 'Lab5_template2023/Trajectory  Generator'
 * '<S6>'   : 'Lab5_template2023/XY Plotter'
 * '<S7>'   : 'Lab5_template2023/PD Controller/Anti-windup'
 * '<S8>'   : 'Lab5_template2023/PD Controller/D Gain'
 * '<S9>'   : 'Lab5_template2023/PD Controller/Filter'
 * '<S10>'  : 'Lab5_template2023/PD Controller/Filter ICs'
 * '<S11>'  : 'Lab5_template2023/PD Controller/I Gain'
 * '<S12>'  : 'Lab5_template2023/PD Controller/Ideal P Gain'
 * '<S13>'  : 'Lab5_template2023/PD Controller/Ideal P Gain Fdbk'
 * '<S14>'  : 'Lab5_template2023/PD Controller/Integrator'
 * '<S15>'  : 'Lab5_template2023/PD Controller/Integrator ICs'
 * '<S16>'  : 'Lab5_template2023/PD Controller/N Copy'
 * '<S17>'  : 'Lab5_template2023/PD Controller/N Gain'
 * '<S18>'  : 'Lab5_template2023/PD Controller/P Copy'
 * '<S19>'  : 'Lab5_template2023/PD Controller/Parallel P Gain'
 * '<S20>'  : 'Lab5_template2023/PD Controller/Reset Signal'
 * '<S21>'  : 'Lab5_template2023/PD Controller/Saturation'
 * '<S22>'  : 'Lab5_template2023/PD Controller/Saturation Fdbk'
 * '<S23>'  : 'Lab5_template2023/PD Controller/Sum'
 * '<S24>'  : 'Lab5_template2023/PD Controller/Sum Fdbk'
 * '<S25>'  : 'Lab5_template2023/PD Controller/Tracking Mode'
 * '<S26>'  : 'Lab5_template2023/PD Controller/Tracking Mode Sum'
 * '<S27>'  : 'Lab5_template2023/PD Controller/Tsamp - Integral'
 * '<S28>'  : 'Lab5_template2023/PD Controller/Tsamp - Ngain'
 * '<S29>'  : 'Lab5_template2023/PD Controller/postSat Signal'
 * '<S30>'  : 'Lab5_template2023/PD Controller/preSat Signal'
 * '<S31>'  : 'Lab5_template2023/PD Controller/Anti-windup/Disabled'
 * '<S32>'  : 'Lab5_template2023/PD Controller/D Gain/Internal Parameters'
 * '<S33>'  : 'Lab5_template2023/PD Controller/Filter/Cont. Filter'
 * '<S34>'  : 'Lab5_template2023/PD Controller/Filter ICs/Internal IC - Filter'
 * '<S35>'  : 'Lab5_template2023/PD Controller/I Gain/Disabled'
 * '<S36>'  : 'Lab5_template2023/PD Controller/Ideal P Gain/Passthrough'
 * '<S37>'  : 'Lab5_template2023/PD Controller/Ideal P Gain Fdbk/Disabled'
 * '<S38>'  : 'Lab5_template2023/PD Controller/Integrator/Disabled'
 * '<S39>'  : 'Lab5_template2023/PD Controller/Integrator ICs/Disabled'
 * '<S40>'  : 'Lab5_template2023/PD Controller/N Copy/Disabled'
 * '<S41>'  : 'Lab5_template2023/PD Controller/N Gain/Internal Parameters'
 * '<S42>'  : 'Lab5_template2023/PD Controller/P Copy/Disabled'
 * '<S43>'  : 'Lab5_template2023/PD Controller/Parallel P Gain/Internal Parameters'
 * '<S44>'  : 'Lab5_template2023/PD Controller/Reset Signal/Disabled'
 * '<S45>'  : 'Lab5_template2023/PD Controller/Saturation/Passthrough'
 * '<S46>'  : 'Lab5_template2023/PD Controller/Saturation Fdbk/Disabled'
 * '<S47>'  : 'Lab5_template2023/PD Controller/Sum/Sum_PD'
 * '<S48>'  : 'Lab5_template2023/PD Controller/Sum Fdbk/Disabled'
 * '<S49>'  : 'Lab5_template2023/PD Controller/Tracking Mode/Disabled'
 * '<S50>'  : 'Lab5_template2023/PD Controller/Tracking Mode Sum/Passthrough'
 * '<S51>'  : 'Lab5_template2023/PD Controller/Tsamp - Integral/Disabled wSignal Specification'
 * '<S52>'  : 'Lab5_template2023/PD Controller/Tsamp - Ngain/Passthrough'
 * '<S53>'  : 'Lab5_template2023/PD Controller/postSat Signal/Forward_Path'
 * '<S54>'  : 'Lab5_template2023/PD Controller/preSat Signal/Forward_Path'
 * '<S55>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem'
 * '<S56>'  : 'Lab5_template2023/Robot and Environment Subsystem/Forward Kinematics'
 * '<S57>'  : 'Lab5_template2023/Robot and Environment Subsystem/Robot Subsystem'
 * '<S58>'  : 'Lab5_template2023/Robot and Environment Subsystem/Rotation to Base Frame'
 * '<S59>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal'
 * '<S60>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1'
 * '<S61>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Second-Order Low-Pass Filter'
 * '<S62>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Second-Order Low-Pass Filter1'
 * '<S63>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal/Enabled Moving Average'
 * '<S64>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal/Switch Case Action Subsystem'
 * '<S65>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal/Switch Case Action Subsystem1'
 * '<S66>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal/Switch Case Action Subsystem2'
 * '<S67>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal/Enabled Moving Average/Increment'
 * '<S68>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1/Enabled Moving Average'
 * '<S69>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1/Switch Case Action Subsystem'
 * '<S70>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1/Switch Case Action Subsystem1'
 * '<S71>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1/Switch Case Action Subsystem2'
 * '<S72>'  : 'Lab5_template2023/Robot and Environment Subsystem/Force Sensor Subsystem/Bias Removal1/Enabled Moving Average/Increment'
 */
#endif                                 /* RTW_HEADER_Lab5_template2023_h_ */
