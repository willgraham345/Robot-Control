###########################################################################
## Makefile generated for component 'stiffness'. 
## 
## Makefile     : stiffness.mk
## Generated on : Thu Apr 06 12:45:20 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\stiffness.rt-win64
...
COMPILER_COMMAND_FILE     = stiffness_comp.rsp
CMD_FILE                  = stiffness.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\stiffness.rt-win64
...
DEFINES_STANDARD = -DMODEL=stiffness -DNUMST=3 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\stiffness_quarc_win64\rtGetInf.c $(START_DIR)\stiffness_quarc_win64\rtGetNaN.c $(START_DIR)\stiffness_quarc_win64\rt_nonfinite.c $(START_DIR)\stiffness_quarc_win64\stiffness.c $(START_DIR)\stiffness_quarc_win64\stiffness_data.c $(START_DIR)\stiffness_quarc_win64\stiffness_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj stiffness.obj stiffness_data.obj stiffness_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\stiffness_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\stiffness_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : $(START_DIR)\stiffness_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\stiffness_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\stiffness_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\stiffness_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\stiffness_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\stiffness_quarc_win64\rt_nonfinite.c


stiffness.obj : $(START_DIR)\stiffness_quarc_win64\stiffness.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\stiffness_quarc_win64\stiffness.c


stiffness_data.obj : $(START_DIR)\stiffness_quarc_win64\stiffness_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\stiffness_quarc_win64\stiffness_data.c


stiffness_main.obj : $(START_DIR)\stiffness_quarc_win64\stiffness_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\stiffness_quarc_win64\stiffness_main.c
